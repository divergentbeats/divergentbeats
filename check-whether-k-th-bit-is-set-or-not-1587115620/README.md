<h2><a href="https://www.geeksforgeeks.org/problems/check-whether-k-th-bit-is-set-or-not-1587115620/1">Check K-th Bit</a></h2>
<h3>Difficulty: Easy</h3>
<hr>
<div class="problem-statement">
<p><span style="font-size: 18px;">Given two positive integer <strong>n&nbsp;</strong>and&nbsp; <strong>k</strong>, check if the <strong>k<sup>th</sup></strong>&nbsp;index bit of&nbsp;<strong>n&nbsp;</strong>is set or not.<br><strong>&nbsp;Note: </strong></span><span style="font-size: 18px;">A bit is called set if it is 1.&nbsp;</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n ≤ 10<sup>9</sup><br>0 ≤ k ≤ 31</span></p>
</div>

---
<p align="center">
  <a href="https://www.geeksforgeeks.org/problems/check-whether-k-th-bit-is-set-or-not-1587115620/1">View Problem on GeeksforGeeks</a>
</p>