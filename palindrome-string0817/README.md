<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-string0817/1">Palindrome String</a></h2>
<h3>Difficulty: Easy</h3>
<hr>
<div class="problem-statement">
<p><span style="font-size: 14pt;">Given a string <strong>s</strong>, return <strong>true</strong> if the string is a <strong>palindrome</strong>. Otherwise, return <strong>false</strong>. </span></p>
...
---
<p align="center">
  <a href="https://www.geeksforgeeks.org/problems/palindrome-string0817/1">View Problem on GeeksforGeeks</a>
</p>