<h2><a href="https://www.geeksforgeeks.org/problems/non-repeating-character-1587115620/1">Non Repeating Character</a></h2>
<h3>Difficulty: Easy</h3>
<hr>
<div class="problem-statement">
<p><span style="font-size: 14pt;">Given a string <strong>s</strong> consisting of <strong>lowercase </strong>English<strong> </strong>Letters. return the first non-repeating character in <strong>s</strong>. </span><span style="font-size: 14pt;">If there is no non-repeating character, return <strong>'$'</strong>.<br></span></p>
...
---
<p align="center">
  <a href="https://www.geeksforgeeks.org/problems/non-repeating-character-1587115620/1">View Problem on GeeksforGeeks</a>
</p>